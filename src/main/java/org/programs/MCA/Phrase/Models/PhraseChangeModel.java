...
public class PhraseChangeModel {
    private String id;
    ...
    public int getFlagSyntezed() {
        return flagSyntezed;
    }

    public void setFlagSyntezed(int flagSyntezed) {
        this.flagSyntezed = flagSyntezed;
    }
}
